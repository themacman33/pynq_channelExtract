...
entity channel_extract_accel is
generic (
...
architecture behav of channel_extract_accel is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "channel_extract_accel,hls_ip_2019_2_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.167000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=637,HLS_SYN_LUT=1386,HLS_VERSION=2019_2_1}";
    ...
    signal Block_Mat_exit3_proc_U0_start_out : STD_LOGIC;
    signal Block_Mat_exit3_proc_U0_start_write : STD_LOGIC;
    signal Block_Mat_exit3_proc_U0_src_mat_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit3_proc_U0_src_mat_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit3_proc_U0_src_mat_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit3_proc_U0_src_mat_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit3_proc_U0_select_ln60_out_out_din : STD_LOGIC_VECTOR (2 downto 0);
    signal Block_Mat_exit3_proc_U0_select_ln60_out_out_write : STD_LOGIC;
    signal Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_write : STD_LOGIC;
    signal Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_write : STD_LOGIC;
    ...
    signal extractChannel_U0_ap_start : STD_LOGIC;
    signal extractChannel_U0_ap_done : STD_LOGIC;
    signal extractChannel_U0_ap_continue : STD_LOGIC;
    signal extractChannel_U0_ap_idle : STD_LOGIC;
    signal extractChannel_U0_ap_ready : STD_LOGIC;
    signal extractChannel_U0_p_src_mat_rows_read : STD_LOGIC;
    signal extractChannel_U0_p_src_mat_cols_read : STD_LOGIC;
    signal extractChannel_U0_p_src_mat_data_V_read : STD_LOGIC;
    signal extractChannel_U0_p_dst_mat_data_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal extractChannel_U0_p_dst_mat_data_V_write : STD_LOGIC;
    signal extractChannel_U0_select_ln60_loc_read : STD_LOGIC;
    ...
    signal select_ln60_loc_c_full_n : STD_LOGIC;
    signal select_ln60_loc_c_dout : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln60_loc_c_empty_n : STD_LOGIC;
    ...
    signal dst_mat_data_V_dout : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal start_for_extractChannel_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_extractChannel_U0_full_n : STD_LOGIC;
    signal start_for_extractChannel_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_extractChannel_U0_empty_n : STD_LOGIC;
    ...
    signal extractChannel_U0_start_full_n : STD_LOGIC;
    signal extractChannel_U0_start_write : STD_LOGIC;
    ...
    port (
        ...
        select_ln60_out_out_din : OUT STD_LOGIC_VECTOR (2 downto 0);
        select_ln60_out_out_full_n : IN STD_LOGIC;
        select_ln60_out_out_write : OUT STD_LOGIC;
    ...
    component start_for_extractbkb IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component channel_extract_accel_AXILiteS_s_axi IS
    generic (
...
begin
    channel_extract_accel_AXILiteS_s_axi_U : component channel_extract_accel_AXILiteS_s_axi
    generic map (
    ...
    port map (
        ...
        start_full_n => start_for_extractChannel_U0_full_n,
        ...
        start_out => Block_Mat_exit3_proc_U0_start_out,
        start_write => Block_Mat_exit3_proc_U0_start_write,
        src_rows => src_rows,
        src_cols => src_cols,
        dst_rows => dst_rows,
        src_mat_rows_out_din => Block_Mat_exit3_proc_U0_src_mat_rows_out_din,
        src_mat_rows_out_full_n => src_mat_rows_c_full_n,
        src_mat_rows_out_write => Block_Mat_exit3_proc_U0_src_mat_rows_out_write,
        src_mat_cols_out_din => Block_Mat_exit3_proc_U0_src_mat_cols_out_din,
        src_mat_cols_out_full_n => src_mat_cols_c_full_n,
        src_mat_cols_out_write => Block_Mat_exit3_proc_U0_src_mat_cols_out_write,
        select_ln60_out_out_din => Block_Mat_exit3_proc_U0_select_ln60_out_out_din,
        select_ln60_out_out_full_n => select_ln60_loc_c_full_n,
        select_ln60_out_out_write => Block_Mat_exit3_proc_U0_select_ln60_out_out_write,
        src_rows_cast1_out_out_din => Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_din,
        src_rows_cast1_out_out_full_n => src_rows_cast1_loc_c_full_n,
        src_rows_cast1_out_out_write => Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_write,
        src_cols_cast2_out_out_din => Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_din,
        src_cols_cast2_out_out_full_n => src_cols_cast2_loc_c_full_n,
        src_cols_cast2_out_out_write => Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_write);
    ...
    extractChannel_U0 : component extractChannel
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => extractChannel_U0_ap_start,
        ap_done => extractChannel_U0_ap_done,
        ap_continue => extractChannel_U0_ap_continue,
        ap_idle => extractChannel_U0_ap_idle,
        ap_ready => extractChannel_U0_ap_ready,
        p_src_mat_rows_dout => src_mat_rows_c_dout,
        p_src_mat_rows_empty_n => src_mat_rows_c_empty_n,
        p_src_mat_rows_read => extractChannel_U0_p_src_mat_rows_read,
        p_src_mat_cols_dout => src_mat_cols_c_dout,
        p_src_mat_cols_empty_n => src_mat_cols_c_empty_n,
        p_src_mat_cols_read => extractChannel_U0_p_src_mat_cols_read,
        p_src_mat_data_V_dout => src_mat_data_V_dout,
        p_src_mat_data_V_empty_n => src_mat_data_V_empty_n,
        p_src_mat_data_V_read => extractChannel_U0_p_src_mat_data_V_read,
        p_dst_mat_data_V_din => extractChannel_U0_p_dst_mat_data_V_din,
        p_dst_mat_data_V_full_n => dst_mat_data_V_full_n,
        p_dst_mat_data_V_write => extractChannel_U0_p_dst_mat_data_V_write,
        select_ln60_loc_dout => select_ln60_loc_c_dout,
        select_ln60_loc_empty_n => select_ln60_loc_c_empty_n,
        select_ln60_loc_read => extractChannel_U0_select_ln60_loc_read);
    ...
    port map (
        ...
        if_din => Block_Mat_exit3_proc_U0_src_mat_rows_out_din,
        if_full_n => src_mat_rows_c_full_n,
        if_write => Block_Mat_exit3_proc_U0_src_mat_rows_out_write,
        if_dout => src_mat_rows_c_dout,
        if_empty_n => src_mat_rows_c_empty_n,
        if_read => extractChannel_U0_p_src_mat_rows_read);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit3_proc_U0_src_mat_cols_out_din,
        if_full_n => src_mat_cols_c_full_n,
        if_write => Block_Mat_exit3_proc_U0_src_mat_cols_out_write,
        if_dout => src_mat_cols_c_dout,
        if_empty_n => src_mat_cols_c_empty_n,
        if_read => extractChannel_U0_p_src_mat_cols_read);

    select_ln60_loc_c_U : component fifo_w3_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit3_proc_U0_select_ln60_out_out_din,
        if_full_n => select_ln60_loc_c_full_n,
        if_write => Block_Mat_exit3_proc_U0_select_ln60_out_out_write,
        if_dout => select_ln60_loc_c_dout,
        if_empty_n => select_ln60_loc_c_empty_n,
        if_read => extractChannel_U0_select_ln60_loc_read);

    src_rows_cast1_loc_c_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_din,
        if_full_n => src_rows_cast1_loc_c_full_n,
        if_write => Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_write,
        if_dout => src_rows_cast1_loc_c_dout,
        if_empty_n => src_rows_cast1_loc_c_empty_n,
        if_read => axis2xfMat_U0_src_rows_cast1_loc_read);

    src_cols_cast2_loc_c_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_din,
        if_full_n => src_cols_cast2_loc_c_full_n,
        if_write => Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_write,
    ...
    port map (
        ...
        if_read => extractChannel_U0_p_src_mat_data_V_read);
    ...
    dst_mat_data_V_U : component fifo_w8_d150_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => extractChannel_U0_p_dst_mat_data_V_din,
        if_full_n => dst_mat_data_V_full_n,
        if_write => extractChannel_U0_p_dst_mat_data_V_write,
        if_dout => dst_mat_data_V_dout,
        if_empty_n => dst_mat_data_V_empty_n,
        if_read => xfMat2axis_U0_p_dst_data_V_read);

    start_for_extractbkb_U : component start_for_extractbkb
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_extractChannel_U0_din,
        if_full_n => start_for_extractChannel_U0_full_n,
        if_write => Block_Mat_exit3_proc_U0_start_write,
        if_dout => start_for_extractChannel_U0_dout,
        if_empty_n => start_for_extractChannel_U0_empty_n,
        if_read => extractChannel_U0_ap_ready);
    ...
    ap_done <= xfMat2axis_U0_ap_done;
    ap_idle <= (xfMat2axis_U0_ap_idle and extractChannel_U0_ap_idle and axis2xfMat_U0_ap_idle and Block_Mat_exit3_proc_U0_ap_idle);
    ...
    ap_sync_ready <= (ap_sync_axis2xfMat_U0_ap_ready and ap_sync_Block_Mat_exit3_proc_U0_ap_ready);
    ...
    dst_TLAST <= xfMat2axis_U0_dst_TLAST;
    dst_TVALID <= xfMat2axis_U0_dst_TVALID;
    extractChannel_U0_ap_continue <= ap_const_logic_1;
    extractChannel_U0_ap_start <= start_for_extractChannel_U0_empty_n;
    extractChannel_U0_start_full_n <= ap_const_logic_1;
    extractChannel_U0_start_write <= ap_const_logic_0;
    src_TREADY <= axis2xfMat_U0_src_TREADY;
    start_for_extractChannel_U0_din <= (0=>ap_const_logic_1, others=>'-');
