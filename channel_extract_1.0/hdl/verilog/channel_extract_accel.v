...
wire    Block_Mat_exit3_proc_U0_start_out;
wire    Block_Mat_exit3_proc_U0_start_write;
wire   [31:0] Block_Mat_exit3_proc_U0_src_mat_rows_out_din;
wire    Block_Mat_exit3_proc_U0_src_mat_rows_out_write;
wire   [31:0] Block_Mat_exit3_proc_U0_src_mat_cols_out_din;
wire    Block_Mat_exit3_proc_U0_src_mat_cols_out_write;
wire   [2:0] Block_Mat_exit3_proc_U0_select_ln60_out_out_din;
wire    Block_Mat_exit3_proc_U0_select_ln60_out_out_write;
wire   [11:0] Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_din;
wire    Block_Mat_exit3_proc_U0_src_rows_cast1_out_out_write;
wire   [11:0] Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_din;
wire    Block_Mat_exit3_proc_U0_src_cols_cast2_out_out_write;
...
wire    extractChannel_U0_ap_start;
wire    extractChannel_U0_ap_done;
wire    extractChannel_U0_ap_continue;
wire    extractChannel_U0_ap_idle;
wire    extractChannel_U0_ap_ready;
wire    extractChannel_U0_p_src_mat_rows_read;
wire    extractChannel_U0_p_src_mat_cols_read;
wire    extractChannel_U0_p_src_mat_data_V_read;
wire   [7:0] extractChannel_U0_p_dst_mat_data_V_din;
wire    extractChannel_U0_p_dst_mat_data_V_write;
wire    extractChannel_U0_select_ln60_loc_read;
...
wire    select_ln60_loc_c_full_n;
wire   [2:0] select_ln60_loc_c_dout;
wire    select_ln60_loc_c_empty_n;
...
wire   [0:0] start_for_extractChannel_U0_din;
wire    start_for_extractChannel_U0_full_n;
wire   [0:0] start_for_extractChannel_U0_dout;
wire    start_for_extractChannel_U0_empty_n;
...
wire    extractChannel_U0_start_full_n;
wire    extractChannel_U0_start_write;
...
channel_extract_accel_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
channel_extract_accel_AXILiteS_s_axi_U(
...
extractChannel extractChannel_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
fifo_w3_d3_A select_ln60_loc_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A src_rows_cast1_loc_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A src_cols_cast2_loc_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d150_A dst_mat_data_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_extractbkb start_for_extractbkb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (xfMat2axis_U0_ap_idle & extractChannel_U0_ap_idle & axis2xfMat_U0_ap_idle & Block_Mat_exit3_proc_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_axis2xfMat_U0_ap_ready & ap_sync_Block_Mat_exit3_proc_U0_ap_ready);
...
assign extractChannel_U0_ap_continue = 1'b1;

assign extractChannel_U0_ap_start = start_for_extractChannel_U0_empty_n;

assign extractChannel_U0_start_full_n = 1'b1;

assign extractChannel_U0_start_write = 1'b0;

assign src_TREADY = axis2xfMat_U0_src_TREADY;

assign start_for_extractChannel_U0_din = 1'b1;
...
endmodule //channel_extract_accel
